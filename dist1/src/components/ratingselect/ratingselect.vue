<template>
  <div class="ratingselect">
    ...
    <div @click.stop.prevent="toggleContent" class="switch" :class="{'on':oContent}">
...
export default {
  ...
  methods: {
    select(type, event) {
      ...
      this.sType = type;
      this.$emit('cart-add', 'selectType', this.sType);
    },
    toggleContent(event) {
      if (!event._constructed) {
        return;
      ...
      this.$emit('cart-add', 'onlyContent', this.oContent);
    },
  },
};
</script>
