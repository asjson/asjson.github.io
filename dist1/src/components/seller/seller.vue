...
import oStorage from 'common/js/store';
...
export default {
  ...
  data() {
    return {
      favorite: (() => {
        return oStorage.loadFromLocal(this.seller.id, 'favorite', false);
      })(),
    };
  },
  // ready() {
  ...
  methods: {
    ...
    toggleFavorite(event) {
      ...
      oStorage.saveToLocal(this.seller.id, 'favorite', this.favorite);
    },
  },
  watch: {
    'seller'() {
